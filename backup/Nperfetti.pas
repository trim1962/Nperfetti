...
Stampa_stampavettore(Out_File_Tex,primi);
...
Stampa_stampavettore(Out_File_Tex,difettivi);
Stampa_chiusuralong(Out_File_Tex);
...
Stampa_stampavettore(Out_File_Tex,soprabbondanti);
Stampa_chiusuralong(Out_File_Tex);
...
Stampa_stampavettore(Out_File_Tex,perfetti);
Stampa_chiusuralong(Out_File_Tex);
