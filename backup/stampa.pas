...
uses
  SysUtils,MyType;
  procedure Stampa_stampatitolo(var t:textfile;titolo,oeis:string);
  ...
  procedure Stampa_stampalinea(var t:textfile;var m:Qword;var numeri:Mytype_array);
  procedure Stampa_stampalinea_Semplificata(var t:textfile;var m:Qword;var numeri:Mytype_array);
  procedure Stampa_stampalinea_Semplificatanozero(var t:textfile;var m:Qword;var numeri:Mytype_array);
  procedure Stampa_stampacsv(var t:textfile;var m:Qword;var numeri:Mytype_array);
  function  Stampa_stampasenonzero(t:Qword):string;
  procedure Stampa_stampavettore(var t:textfile;var numeri:Mytype_array);
